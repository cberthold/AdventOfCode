...
{
    public class Day4PassPhraseCheckerTests
    {
        [Fact]
        public void Count_number_of_valid_phrases()
        {
            string phraseList = @"
...
jwfm ptjwrbl hhuv uolz adyweh qpj wxyogp igvnojq jmfw pqs fsnirby";
            ...
            using (var sr = new StringReader(phraseList))
            {
                string line;
                int validCount = 0;
        ...
        [Fact]
        public void Pass_phrase_with_duplicates_should_be_invalid()
        {
            // assemble
            var checker = new PassPhraseChecker();
        ...
        [Fact]
        public void Pass_phrase_with_no_duplicates_should_be_valid()
        {
            // assemble
            var checker = new PassPhraseChecker();
        ...
        [Fact]
        public void Pass_phrase_with_no_duplicates_but_one_that_looks_almost_like_duplicate_should_be_valid()
        {
            // assemble
            var checker = new PassPhraseChecker();
        ...
        [Fact]
        public void Given_phrases_find_valid_non_anagram_phrases()
        {
            string phrases = @"
bdwdjjo avricm cjbmj ran lmfsom ivsof
mxonybc fndyzzi gmdp gdfyoi inrvhr kpuueel wdpga vkq
...
jwfm ptjwrbl hhuv uolz adyweh qpj wxyogp igvnojq jmfw pqs fsnirby";
            ...
            var checker = new PassPhraseAntiAnagramChecker();
            using (var sr = new StringReader(phrases))
            {
                string line;
                int validCount = 0;
                while ((line = sr.ReadLine()) != null)
